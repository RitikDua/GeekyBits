...
function Onevsone() {
    ...
    return (
        <div style={{paddingTop:"50px"}}>
            ...
            {(copy1 || copy2) && <div style={{paddingLeft:"30%",width:"650px",zIndex:"100",position:"absolute"}}><Alert severity="success">Copied</Alert></div>}
            <Grid container style={{zIndex:"-1"}}>
                ...
                <Grid item xs={7}>
                    {register && contest &&
                    <div>
                        <div style={{display:"flex"}}><div style={{fontSize:"25px"}}><span>Contest-URL: &nbsp;&nbsp;</span></div><CopyToClipboard text={contest}
          onCopy={() => setcopy(true)}><div onClick={()=>handlecopy1()} style={{backgroundColor:"#F5F5F5",width:"550px",padding:"1% 2%"}}><span>{contest}</span></div></CopyToClipboard></div><br/>
