  ...
  const drawer = (
    <div>
      ...
      <List>
          ...
          <Link to={`/profile`} style={{ textDecoration: 'none','color':'black' }}><ListItem button key="Rank" style={{height:"160px",width:"100%",textAlign:"center"}}><BarChartIcon style={{fontSize:"40px"}}/> <ListItemText primary="Profile" /></ListItem></Link>
