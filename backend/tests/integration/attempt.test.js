...
describe("/attempts", () => {
  ...
  describe("GET /", () => {
    it("should return all contests", async () => {
      ...
      expect(res.body.data.attempts).toHaveProperty("attemptType", dbAttempt.attemptType);
    });
  });
  ...
  describe("GET /:id", () => {
    ...
    // it("should return 404 if no attempt with given id exist", async () => {
